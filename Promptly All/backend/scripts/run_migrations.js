...
console.log(`[Promptly] Using database path: ${env.SQLITE_PATH}`);

for (const migration of migrations) {
  try {
    console.log(`[Promptly] Running ${migration}...`);
    ...
    console.error(`[Promptly] ❌ Failed to run ${migration}`);
...
console.log('[Promptly] ✅ All migrations completed successfully.');
