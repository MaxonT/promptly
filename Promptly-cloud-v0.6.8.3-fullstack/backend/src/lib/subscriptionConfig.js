...
export const SUCCESS_URL = `${FRONTEND_URL}/subscription/success`;
export const CANCEL_URL = `${FRONTEND_URL}/subscription/cancel`;
export const ACCOUNT_URL = `${FRONTEND_URL}/account`;
...
console.log("[promptly] Subscription config loaded");
console.log(`[promptly]   Monthly: $${MONTHLY_PRICE_USD}/mo (${formatTokens(MONTHLY_PLAN_TOKENS)} tokens)`);
console.log(`[promptly]   Yearly: $${YEARLY_PRICE_USD}/yr (${formatTokens(YEARLY_PLAN_TOKENS)} tokens)`);
console.log(`[promptly]   Trial: ${TRIAL_DAYS} days (${formatTokens(TRIAL_BASE_TOKENS)} base + ${formatTokens(TRIAL_DAILY_TOKENS)}/day)`);
