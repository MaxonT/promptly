...
`;
  ...
  overlay.innerHTML = `
    <div class="redeem-modal" style="position:relative;">
      ...
      <div class="redeem-modal__input-group">
        <input class="redeem-modal__input" type="text" placeholder="e.g. PROMPTLY-XXXX" maxlength="30" autocomplete="off" spellcheck="false" />
  ...
  function getAuthToken() {
    try {
      return localStorage.getItem("promptly.token") || null;
    } catch {
      return null;
    }
  }
