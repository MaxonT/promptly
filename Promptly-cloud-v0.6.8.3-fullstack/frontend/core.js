...
(function(){
  ...
  const translations={
    en:{nav_home:"Dashboard",nav_privacy:"Privacy",nav_terms:"Terms",nav_cookies:"Cookies",nav_account:"Account",appearance:"System",auto:"System",light:"Light",dark:"Dark",language:"English",
        ...
        task_label:"Task",examples_label:"Examples (optional)",best_prompt:"Best Prompt",run_btn:"Run Optimization",processing:"Processing...",
    ...
    zh:{nav_home:"仪表盘",nav_privacy:"隐私政策",nav_terms:"服务条款",nav_cookies:"Cookie 政策",nav_account:"账号",appearance:"系统",auto:"系统",light:"浅色",dark:"深色",language:"中文",
        ...
        task_label:"任务",examples_label:"示例（可选）",best_prompt:"最佳 Prompt",run_btn:"运行优化",processing:"处理中...",
        ...
        placeholder_examples:"POS || I love this!\nNEG || This is terrible."},
    es:{language:"Español",processing:"Procesando..."},fr:{language:"Français",processing:"Traitement..."},ja:{language:"日本語",processing:"処理中..."},ko:{language:"한국어",processing:"처리 중..."},ar:{language:"العربية",processing:"جاري المعالجة..."},pt:{language:"Português",processing:"Processando..."},hi:{language:"हिन्दी",processing:"प्रोसेसिंग..."}
  };
