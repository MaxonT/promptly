...
// 导出安全检查器
window.PromptlySecurityChecker = SecurityChecker;

// 在开发环境自动启动
if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
  window.promptlySecurity = new SecurityChecker();
  
  // 提供全局方法供调试使用
  window.getSecurityReport = () => window.promptlySecurity.getSecurityReport();
